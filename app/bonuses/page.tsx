      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Thank you for your interest in &ldquo;{BOOK_SHORT_TITLE}&rdquo;! Download these exclusive bonus materials.
          </p>
        </div>
        ...
        <section className="mb-16">
          <Card className="p-8">
            ...
            <p className="text-gray-600 mb-6">
              Download the companion workbook for &ldquo;{BOOK_SHORT_TITLE}&rdquo;.
            </p>

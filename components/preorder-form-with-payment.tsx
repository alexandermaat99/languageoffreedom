    ...
    <div className="w-full max-w-4xl mx-auto p-8">
      ...
      <div className="text-center mb-8">
        <h3 className="text-3xl font-bold text-gray-900 mb-2">
          Preorder &ldquo;{bookInfo?.title || "this book"}&rdquo;
        </h3>
                    ...
                    <div className="p-3 border border-gray-300 rounded-md bg-white min-h-[200px]">
                      {stripe && elements && clientSecret ? (
                        ...
                        <div className="text-sm text-gray-500 py-8 text-center">
                          ...
                          <p className="text-xs mt-2">Secure payment options: Card, Klarna, Amazon Pay, or Google Pay</p>
                        </div>
                      )}
                    </div>
                    <p className="text-xs text-gray-500 mt-2">
                      Secure payment options: Card, Klarna, Amazon Pay, or Google Pay
                    </p>
                  </div>
                  <button
                    type="button"
